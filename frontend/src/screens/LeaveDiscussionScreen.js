...
const LeaveDiscussionScreen = ({ route, navigation }) => {
    ...
    const fetchMessages = async () => {
        try {
            const res = await api.get(`/api/leave/requests/${requestId}/discussion`);
    ...
    const sendMessage = async () => {
        ...
        setSending(true);
        try {
            await api.post(`/api/leave/requests/${requestId}/message`, {
                message: newMessage
            });
            setNewMessage('');
            Keyboard.dismiss();
    ...
    return (
        ...
        >
                    ...
                    messages.map((msg, index) => {
                        ...
                        return (
                            <View key={index} style={[styles.messageRow, isMe ? styles.myMessageRow : styles.theirMessageRow]}>
                                ...
                                <View style={[styles.messageBubble, isMe ? [styles.myBubble, { backgroundColor: theme.primaryColor }] : styles.theirBubble]}>
            ...
            <View style={styles.inputArea}>
                ...
                />
                <TouchableOpacity
                    style={[styles.sendBtn, { backgroundColor: theme.primaryColor }]}
                    onPress={sendMessage}
                    disabled={sending}
                >
