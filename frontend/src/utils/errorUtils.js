...
export const getFriendlyErrorMessage = (error, defaultMsg = "Something went wrong") => {
    ...
    if (detail) {
        ...
        // Auth / Login Screen
        if (detailStr.includes("do not belong to this organization")) {
            return "Access denied. This account does not belong to the selected organization. Please select the correct organization.";
        }
